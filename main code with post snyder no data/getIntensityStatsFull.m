...
% constant between the ODE points (of course lam is constant between jumps)

% Function to calculate statistics of actual and estimated intensity
function [lamn lamcapn Tn stats qn] = getIntensityStatsFull(lam, lamcapFull, Tset, T, Qset)
...
en = lamn - lamcapn;
[stats.maxErr stats.meanErr stats.varErr stats.minErr] = calcStats2(en, Tn);
