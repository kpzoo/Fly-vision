...
inpB.kbirth = 1/1000;
inpB.kdeath = 1/1000;
inpB.Nset = [20000 150000];
inpB.Slim = [0 1];
inpB.beta_ratio = [1000:1000:10000];
...
inpB.birType = [7 3];
inpB.deaType = [2 0];
kgainSet = inpB.beta_ratio*inpB.kbirth;
...
if any(batchNo == 1)
    ...
    for i = 1:lenB1
        ...
        inpB.simname = ['simQuick' num2str(i)];
        outB = runDSPP2FnNotPostSnyd(inpB);
