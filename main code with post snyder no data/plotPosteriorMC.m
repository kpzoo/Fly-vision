...
if tit_id
    title(['Intensity error curve at [kg kb kd relspd] = ' num2str(kg) ' ' num2str(reldyn)]);
else
...
if tit_id
    title(['Population comparison at [kg kb kd relspd] = ' num2str(kg) ' ' num2str(reldyn)]);
else
...
if tit_id
    title(['Successive KL divergence at [kg kb kd relspd] = ' num2str(kg) ' ' num2str(reldyn)]);
else
...
if tit_id
    title(['Posterior density at [kg kb kd relspd] = ' num2str(kg) ' ' num2str(reldyn)]);
else
