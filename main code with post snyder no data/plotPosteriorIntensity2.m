% Needs to assign names for cases when batch is across different variables
% <--------------------------------------------------------- must write 
...
function plotPosteriorIntensity2(T, q, lam, lamcap, S, kg, kb, kd, reldyn, save_sim, plot_on)
