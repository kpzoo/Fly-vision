...
function outB = runDSPPfilterFn(inpB)
...
kb = params.kbirth;
kd = params.kdeath;
plotPosteriorIntensity2(T, q, lam, lamcap, S, kg, kb, kd, reldyn, save_sim2, plot_on1);
...
outB.Tn = Tn;
outB.reldyn = reldyn;
outB.birth = output.birth;
outB.death = output.death;
