...
function outFil = generalSnyFilterBasic3(q0, x1cap0, Q, lamInp, nPos, Tphot, Sx, nEvents, Tevent, calcBools, posDirSpace, intenSpace, modtype)
...
% Declare probability variables and initialise
...
% Assign output data to a single structure which includes estimates for the
% MC states as well as the aggregrated position and directional states
outFil.q = q;
outFil.t = t;
outFil.x1cap = x1cap;
outFil.dcap = dcap;
