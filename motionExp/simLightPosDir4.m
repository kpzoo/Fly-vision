...
function [X T posStats Q] = simLightPosDir4(dattype, modtype, inpType, inten, Nev, nPos, nStates, test, fullWave, matching)
...
[X, Xdot, T] = gillespieQGeneral4(inpGill);
pos = X(:, 1);
