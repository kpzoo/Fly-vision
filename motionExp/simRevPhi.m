...
if cell1
    ...
    % Obtain the Q and Lam matrices for the Snyder filter
    if testCon
        testDir = [0 1];
    ...
    intenInp.i0 = i0;
    intenInp.ic = ic;
    lamInp = getLamManyStreams(modVal, nPos, nStates, intenInp);
    ...
    [X T posStats Qphi] = simLightPosDir3(datVal, modVal, modType, intenInp, Nev, nPos, nStatesRevPhi, test, fullWave);
