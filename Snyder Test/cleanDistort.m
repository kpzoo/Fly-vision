...
function out = cleanDistort(locfolder1, locfolder2, adjust, noiseTraits, limPhoton, simname)
...
for iw = 1:lenTh
    ...
    Test{iw} = distortPhotons(noiseTraits{iw}, Treal, T);
    ...
    distTest(iw) = spkd(Treal(1:metricPhotonLim), Test{iw}(1:metricPhotonLim), dtcost);
    ...
    meanEst(iw) = x1StatsEst.meth1(1);
    mseEst(iw) = x1StatsEst.meth1(3);
end
