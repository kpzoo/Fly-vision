% Modification to include transition matrix calculation from the intensity
% matrix i.e. P = exp(tQ) Kolmogorov solution
...
function [Q P] = getPQMx(birStr, kbirth, kdeath, Slim)
