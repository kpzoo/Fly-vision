% Modified to allow for rate calculation via Q matrix and works with the
% modified code gillespieManyReactionsQ
...
% Extra parameters for Q matrix method
Q = params.Q;
useQ = params.useQ;
...
% Additional inputs for Q matrix method
inpGill.useQ = useQ;
inpGill.Q = Q;
inpGill.restrict = restrict;
...
[X Xdot T] = gillespieManyReacsQ(inpGill);
