...
if ~skip_SSA
    ...
    jumpMax = 1;
    switch(jumpMax) % <---------- altered cases, now case 1 is max reaction of 1 vs 2 
        case 1
            params.reacType = [1 1 2];
            params.r_const = [10 10 1000];
            params.bulk = [1 1 1];
            params.transit = [1 -1 0; 0 0 1];
            params.molecType = [1 1 2];
            params.crossType = [1 1 1];            
        case 2
    ...
    if params.SlimSet.min(1) == 0
        ...
        struc = 1;
        statdistr = 2;
        [Q P Pi] = solveQGenFn(nState, struc, statdistr);
    else
