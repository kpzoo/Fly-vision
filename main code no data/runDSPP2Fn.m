...
if ~skip_Snyder
    ...
    if save_sim1
        save(simname, 'outGil', 'x1n', 'x1capn', 'Tn', 'x1Stats', 'kg', 'kb',...
            'kd', 'x1rateMean', 'x2rateMean', 'relbnd', 'reldyn', 'Nratio', 'N1', 'N2');
    end
    % Remove unnecessary variables
    clear q qODE lamn lamcapn lamcap x1n x1 x2 T lamCapFull outFil t T X Xdot x1Set Tset
end
