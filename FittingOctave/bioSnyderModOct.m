...
function [lamstats x1Stats x1n x1capn Tn] = bioSnyderModOct(T, X, kgain, Q, S, params, no_bnd, octave)
...
outFil = filterHybrid3Oct(lamcap0, q0, B, T, S, x1cap0, coeff, lenS, birStr2, params, x2, octave);
