...
function outFil = filterHybrid3Oct(lamcap0, q0, B, T, S, x1cap0, coeff, lenS, birStr2, params, x2, octave)
        ...
        case 0
            if ~int_sw
                if ~octave
                    ...
                    dtset = (Tevent(i) - Tevent(i-1))/25;
                    tset = Tevent(i-1):dtset:Tevent(i);
                    tset = tset';
                    odeFN = @(qset, ts) odeSnyderOct(qset, ts, B, coeff, S, birStr2);
