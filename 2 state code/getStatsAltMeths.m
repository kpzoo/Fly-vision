...
function statSet = getStatsAltMeths(Tn, x1n, x1capn)
...
for i = 2:nSetSamps+1
    ...
    % eSamp = interp1(Ttemp, etemp, Tsamp);
    x1Samp = interp1(Ttemp, x1temp, Tsamp);
    x1capSamp = interp1(Ttemp, x1captemp, Tsamp);
